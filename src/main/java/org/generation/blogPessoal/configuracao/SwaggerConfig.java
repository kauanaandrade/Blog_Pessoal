package org.generation.blogPessoal.configuracao;
...
public class SwaggerConfig {
	...
	public static ApiInfo metadata() {
		return new ApiInfoBuilder().title(" Blog Pessoal ").description("Projeto API Spring - Blog Pessoal")
				...
				.licenseUrl("https://github.com/kauanaandrade").contact(contact()).build();
	}

	private static Contact contact() {
		return new Contact("Kauana Andrade", "https://github.com/kauanaandrade",
				"kauana.andrade151116@gmail.com");
	}
